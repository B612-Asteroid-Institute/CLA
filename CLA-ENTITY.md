# B612 Asteroid Institute Entity Contributor License Agreement
Thank you for your interest in contributing to B612 Asteroid Institute ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by electronic submission, following the instructions at https://github.com/B612-Asteroid-Institute/adam/blob/master/README.md. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://github.com/B612-Asteroid-Institute/adam/blob/master/README.md.
...
(d) You have followed the instructions in https://github.com/B612-Asteroid-Institute/adam/blob/master/README.md, if You do not own the Copyright in the entire work of authorship Submitted.
